...
import io.lightplugins.inventory.util.SubPlaceholder;
import io.lightplugins.inventory.util.database.SQLDatabase;
import io.lightplugins.inventory.util.database.impl.MySQLDatabase;
import io.lightplugins.inventory.util.database.impl.SQLiteDatabase;
import io.lightplugins.inventory.util.database.model.ConnectionProperties;
import io.lightplugins.inventory.util.database.model.DatabaseCredentials;
...
import io.lightplugins.inventory.util.manager.PlaceholderManager;
...
public class LightMaster extends JavaPlugin {
    ...
    public void onLoad() {
        ...
        if(!this.initDatabase()) {
            ...
            getDebugPrinting().print("§4LightInventory is shutting down... ");
    ...
    public void onEnable() {
        ...
        debugPrinting.print("Loading lightInventory modules...");
